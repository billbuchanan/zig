...
pub fn main() !void {
    ...
    const kp = crypto.kem.ml_kem.MLKem768.KeyPair.generate();

    const ct = crypto.kem.ml_kem.MLKem768.PublicKey.encaps(kp.public_key, seed);
    ...
    const sharedkey = try crypto.kem.ml_kem.MLKem768.SecretKey.decaps(kp.secret_key, &ct.ciphertext);
    ...
    try stdout.print("Hybrid ML-KEM-768 Encryption\n", .{});
